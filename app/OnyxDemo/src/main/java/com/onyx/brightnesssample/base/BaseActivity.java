...
public class BaseActivity extends AppCompatActivity implements ISupportActivity {
    final SupportActivityDelegate supportDelegate = new SupportActivityDelegate(this);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Device.currentDevice().configLightStatusBar(getWindow());
    ...
    /**
     * Note： return supportDelegate.dispatchTouchEvent(ev) || super.dispatchTouchEvent(ev);
     */
    @Override
    public boolean dispatchTouchEvent(MotionEvent ev) {
        return supportDelegate.dispatchTouchEvent(ev) || super.dispatchTouchEvent(ev);
    }
    ...
    public FragmentAnimator getFragmentAnimator() {
        return supportDelegate.getFragmentAnimator();
    }
    ...
    public void setFragmentAnimator(FragmentAnimator fragmentAnimator) {
        supportDelegate.setFragmentAnimator(fragmentAnimator);
    }
    ...
    public void setDefaultFragmentBackground(@DrawableRes int backgroundRes) {
        supportDelegate.setDefaultFragmentBackground(backgroundRes);
    }
